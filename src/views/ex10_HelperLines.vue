...
import helperLine from '../views/HelperLines/helperLine.vue'
import { getHelperLines } from '../js/utils'
import { initialNodes } from '../js/initialElements'
...
<template>
  <VueFlow :nodes="nodes" fit-view-on-init @nodes-change="onNodesChange">
    <helperLine :horizontal="helperLineHorizontal" :vertical="helperLineVertical" />
  </VueFlow>
</template>
